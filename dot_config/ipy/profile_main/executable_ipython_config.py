...
#  Default: []
# c.InteractiveShellApp.exec_files = ['ipython_init.py']
...
#     },
# ]
# c.TerminalInteractiveShell.llm_provider_class = "examples.auto_suggest_llm.OllamaCompletionProvider"
# c.TerminalInteractiveShell.llm_constructor_kwargs = {"model": "qwen2.5-coder:latest"}
## lines of code to run at IPython startup.
#  Default: []
c.InteractiveShellApp.exec_lines = ["%autoreload 2", "%alias cls clear", "%alias printenv /bin/sh ~/scripts/printenv_color.sh | sort', 'cls': 'clear"]

## A list of dotted module names of IPython extensions to load.
#  Default: []
c.InteractiveShellApp.extensions = ["autoreload", "storemagic", "cython"]
...
#  working
#  Default: 1000
c.InteractiveShell.cache_size = 50000
...
c.TerminalInteractiveShell.cache_size = 50000
...
#  Default: 0
c.HistoryManager.db_cache_size = 4
